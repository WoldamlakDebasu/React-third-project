...
import "./Opages.css";
import img21 from "./oimages/hotelimage.jpeg";
...
const Capri= ()=> {
    return <div className="addis">
      <div className="fourthaddis">
        <h1>Our New Luxurious hotel found Hotel Located in Capri, Toronto, Canada </h1>
        <img src={img21} width="600" height="400"/>
        </div>

<div className="middle-footer">

<div className="bodytext">
 <h1>WELCOME TO OUR NEW HOTEL LOCATED AT CAPRINO, DUBAI</h1>

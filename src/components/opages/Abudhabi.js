...
import "./Opages.css";
import img20 from "./oimages/newview.jpg";
...
const Abudhabi= ()=> {
    return <div className="addis">
      <div className="thirdaddis">
      <h1>Our New hotel found in Abudhabi, Dubai, Middle East is our main hotel.</h1>
      <img src={img20} width="100%" height="600"/>
      </div>
...
<div className="bodytext">
 <h1>WELCOME TO OUR NEW HOTEL LOCATED AT ABUDHABI</h1>

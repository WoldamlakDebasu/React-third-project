...
import "./Opages.css";
import img18 from "./oimages/newhotelview.jpg";
...
const Addis= ()=> {
    return <div className="addis">
        <div className="firstaddis">
     <h1>Our New hotel found Hotel in Addis ababa, Arat Kilo, Arada Sub-City.</h1>
    <img src={img18} width="600" height="500"/>
        </div>

       <div className="middle-footer">

       <div className="bodytext">
        <h1>WELCOME TO OUR NEW HOTEL LOCATED ARAT KILO</h1>

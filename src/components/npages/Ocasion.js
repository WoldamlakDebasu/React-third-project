...
import "./Npages.css";
import img24 from "./nimages/confer.jpeg";
...
<div className="ocasions">
  <div className="firstocasion">
 <h1>Our Hotels have different Ocasions!</h1> 
 <p>
  <h1>Our hotel prepares different Ocasions:</h1>
  <ul>
    <li>Our Wedding Cermonies</li>
    <li>Our Hotel Conference Ocasions</li>
    <li>Our Hotel Concert Ocasions</li>
    <li>Great Parties in our Hotel</li>
  </ul>
 </p>
 </div>

 <div className="secondocasion">
 <img src={img24} width="600" height="500"/>
 </div>

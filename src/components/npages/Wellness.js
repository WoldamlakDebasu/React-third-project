...
import "./Npages.css";
import img23 from "./nimages/wellness.jpg";
...
const Wellness = ()=> {
    return <div className="dining">
      ...
      <div className="wellness">
        ...
        <div className="firstwellness">
        <h1>Let's see the safety of our Luxury Hotel</h1>
        <p>Our hotel is safe which protects the wellness of our customers
          we respect the the rights of our customers so our hotel gives 
          the first safty proceeds your and families safety and wellness.
          Four Seasons Hotel New York Downtown offers a first class relaxation
           experience from luxury spa treatment amenities to resident healer sessions & more.
        </p>
        </div>

        <div className="secondWellness">
        <img src={img23} width="500" height="400"/> 
        </div>
       ...
       <div className="bodytext">
        <h1>OUR HOTEL GIVES A SEFETY SERVICE FOR OUR GUESTS.</h1>
